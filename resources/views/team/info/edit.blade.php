                            ...
                            <div class="body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-float">
                                            <input type="password" class="form-control" placeholder=" Enter Company Password"
                                                name="name" required>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <a href="{{ route('company.info.create') }}" class="btn btn-raised btn-success waves-effect" type="submit">Update</a>
                            </div>
                        </form>
                    </div>
                </div>
